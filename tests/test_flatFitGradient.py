...
class FlatFitGradientTestCase(lsst.utils.tests.TestCase):
    ...
    def test_apply(self):
        ...
        self.assertFloatsAlmostEqual(gradient.radialSplineValues, radial_values_sky, atol=1e-2)
        self.assertFloatsAlmostEqual(gradient.itlRatio, itl_ratio, atol=2e-4)
