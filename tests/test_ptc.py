...
class MeasurePhotonTransferCurveTaskTestCase(lsst.utils.tests.TestCase):
    ...
    def test_lsstcam_samples(self):
        for dense in [False, True]:
            for upturn in [False, True]:
                rawMeans, rawVars, ptcTurnoff = self._getSampleMeanAndVar(dense=dense, upturn=upturn)
    ...
    def _getSampleMeanAndVar(self, dense=False, upturn=False):
        ...
        dense : `bool`, optional
            Return a dense PTC?
        upturn : `bool`, optional
            Return a PTC with a high flux upturn?
