    ...
    def setUp(self):
        ...
        self.inputMeasurements = [
            {'CTI': {'C:0,0': {'FIRST_COLUMN_MEAN': 117.810165, 'LAST_COLUMN_MEAN': 1.09791130e+02,
                               'IMAGE_MEAN': 117.810165, 'SERIAL_OVERSCAN_VALUES': overscanMeansA,
            ...
            {'CTI': {'C:0,0': {'FIRST_COLUMN_MEAN': 36562.082, 'LAST_COLUMN_MEAN': 3.45901172e+04,
                               'IMAGE_MEAN': 36562.082, 'SERIAL_OVERSCAN_VALUES': overscanMeansB,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)]},
            ...
            {'CTI': {'C:0,0': {'FIRST_COLUMN_MEAN': 994.811, 'LAST_COLUMN_MEAN': 936.415,
                               'IMAGE_MEAN': 994.811, 'SERIAL_OVERSCAN_VALUES': overscanMeansC,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)]},
            ...
            {'CTI': {'C:0,0': {'FIRST_COLUMN_MEAN': 12215.778, 'LAST_COLUMN_MEAN': 11536.875,
                               'IMAGE_MEAN': 12215.778, 'SERIAL_OVERSCAN_VALUES': overscanMeansD,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)]},
