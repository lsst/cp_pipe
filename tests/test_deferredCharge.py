...
class CpCtiSolveTaskTestCase(lsst.utils.tests.TestCase):
    ...
    def setUp(self):
        ...
        serialOscanMeansA = [
            7.18039751e-01, 4.56550479e-01, 4.14261669e-01, 2.88099229e-01, -2.34310962e-02,
        ...
        serialOscanMeansB = [
            1.50365152e+01, 4.43178511e+00, 2.66550946e+00, 1.67382801e+00, 1.10997069e+00,
        ...
        serialOscanMeansC = [
            0.212578110, 0.107817403, -0.122200218, -0.0089812368, -0.067990060, 0.040077099,
        ...
        serialOscanMeansD = [
            4.0867248, 1.43194193, 0.95319573, 0.43219185, 0.53112239, 0.28648, 0.323903486,
        ...
        self.inputMeasurements = [
            {'CTI': {'C:0,0': {'FIRST_COLUMN_MEAN': 117.810165, 'LAST_COLUMN_MEAN': 1.09791130e+02,
                               'IMAGE_MEAN': 117.810165, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansA,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:0,1': {'FIRST_COLUMN_MEAN': 117.810165, 'LAST_COLUMN_MEAN': 1.09791130e+02,
                               'IMAGE_MEAN': 117.810165, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansA,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:0,2': {'FIRST_COLUMN_MEAN': 117.810165, 'LAST_COLUMN_MEAN': 1.09791130e+02,
                               'IMAGE_MEAN': 117.810165, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansA,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:0,3': {'FIRST_COLUMN_MEAN': 117.810165, 'LAST_COLUMN_MEAN': 1.09791130e+02,
                               'IMAGE_MEAN': 117.810165, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansA,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:1,0': {'FIRST_COLUMN_MEAN': 117.810165, 'LAST_COLUMN_MEAN': 1.09791130e+02,
                               'IMAGE_MEAN': 117.810165, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansA,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:1,1': {'FIRST_COLUMN_MEAN': 117.810165, 'LAST_COLUMN_MEAN': 1.09791130e+02,
                               'IMAGE_MEAN': 117.810165, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansA,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:1,2': {'FIRST_COLUMN_MEAN': 117.810165, 'LAST_COLUMN_MEAN': 1.09791130e+02,
                               'IMAGE_MEAN': 117.810165, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansA,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:1,3': {'FIRST_COLUMN_MEAN': 117.810165, 'LAST_COLUMN_MEAN': 1.09791130e+02,
                               'IMAGE_MEAN': 117.810165, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansA,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
            ...
            {'CTI': {'C:0,0': {'FIRST_COLUMN_MEAN': 36562.082, 'LAST_COLUMN_MEAN': 3.45901172e+04,
                               'IMAGE_MEAN': 36562.082, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansB,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:0,1': {'FIRST_COLUMN_MEAN': 36562.082, 'LAST_COLUMN_MEAN': 3.45901172e+04,
                               'IMAGE_MEAN': 36562.082, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansB,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:0,2': {'FIRST_COLUMN_MEAN': 36562.082, 'LAST_COLUMN_MEAN': 3.45901172e+04,
                               'IMAGE_MEAN': 36562.082, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansB,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:0,3': {'FIRST_COLUMN_MEAN': 36562.082, 'LAST_COLUMN_MEAN': 3.45901172e+04,
                               'IMAGE_MEAN': 36562.082, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansB,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:1,0': {'FIRST_COLUMN_MEAN': 36562.082, 'LAST_COLUMN_MEAN': 3.45901172e+04,
                               'IMAGE_MEAN': 36562.082, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansB,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:1,1': {'FIRST_COLUMN_MEAN': 36562.082, 'LAST_COLUMN_MEAN': 3.45901172e+04,
                               'IMAGE_MEAN': 36562.082, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansB,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:1,2': {'FIRST_COLUMN_MEAN': 36562.082, 'LAST_COLUMN_MEAN': 3.45901172e+04,
                               'IMAGE_MEAN': 36562.082, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansB,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:1,3': {'FIRST_COLUMN_MEAN': 36562.082, 'LAST_COLUMN_MEAN': 3.45901172e+04,
                               'IMAGE_MEAN': 36562.082, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansB,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
            ...
            {'CTI': {'C:0,0': {'FIRST_COLUMN_MEAN': 994.811, 'LAST_COLUMN_MEAN': 936.415,
                               'IMAGE_MEAN': 994.811, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansC,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:0,1': {'FIRST_COLUMN_MEAN': 994.811, 'LAST_COLUMN_MEAN': 936.415,
                               'IMAGE_MEAN': 994.811, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansC,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:0,2': {'FIRST_COLUMN_MEAN': 994.811, 'LAST_COLUMN_MEAN': 936.415,
                               'IMAGE_MEAN': 994.811, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansC,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:0,3': {'FIRST_COLUMN_MEAN': 994.811, 'LAST_COLUMN_MEAN': 936.415,
                               'IMAGE_MEAN': 994.811, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansC,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:1,0': {'FIRST_COLUMN_MEAN': 994.811, 'LAST_COLUMN_MEAN': 936.415,
                               'IMAGE_MEAN': 994.811, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansC,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:1,1': {'FIRST_COLUMN_MEAN': 994.811, 'LAST_COLUMN_MEAN': 936.415,
                               'IMAGE_MEAN': 994.811, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansC,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:1,2': {'FIRST_COLUMN_MEAN': 994.811, 'LAST_COLUMN_MEAN': 936.415,
                               'IMAGE_MEAN': 994.811, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansC,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:1,3': {'FIRST_COLUMN_MEAN': 994.811, 'LAST_COLUMN_MEAN': 936.415,
                               'IMAGE_MEAN': 994.811, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansC,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
            ...
            {'CTI': {'C:0,0': {'FIRST_COLUMN_MEAN': 12215.778, 'LAST_COLUMN_MEAN': 11536.875,
                               'IMAGE_MEAN': 12215.778, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansD,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:0,1': {'FIRST_COLUMN_MEAN': 12215.778, 'LAST_COLUMN_MEAN': 11536.875,
                               'IMAGE_MEAN': 12215.778, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansD,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:0,2': {'FIRST_COLUMN_MEAN': 12215.778, 'LAST_COLUMN_MEAN': 11536.875,
                               'IMAGE_MEAN': 12215.778, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansD,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:0,3': {'FIRST_COLUMN_MEAN': 12215.778, 'LAST_COLUMN_MEAN': 11536.875,
                               'IMAGE_MEAN': 12215.778, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansD,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:1,0': {'FIRST_COLUMN_MEAN': 12215.778, 'LAST_COLUMN_MEAN': 11536.875,
                               'IMAGE_MEAN': 12215.778, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansD,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:1,1': {'FIRST_COLUMN_MEAN': 12215.778, 'LAST_COLUMN_MEAN': 11536.875,
                               'IMAGE_MEAN': 12215.778, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansD,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:1,2': {'FIRST_COLUMN_MEAN': 12215.778, 'LAST_COLUMN_MEAN': 11536.875,
                               'IMAGE_MEAN': 12215.778, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansD,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
                               'INPUT_GAIN': 1.5,
                               'INPUT_PTCTURNOFF': numpy.inf},
                     'C:1,3': {'FIRST_COLUMN_MEAN': 12215.778, 'LAST_COLUMN_MEAN': 11536.875,
                               'IMAGE_MEAN': 12215.778, 'SERIAL_OVERSCAN_VALUES': serialOscanMeansD,
                               'SERIAL_OVERSCAN_COLUMNS': [x for x in range(0, 64)],
                               'PARALLEL_OVERSCAN_VALUES': parallelOscanMeans,
                               'PARALLEL_OVERSCAN_ROWS': [x for x in range(0, 10)],
