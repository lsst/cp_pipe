...
SPOTS_REPO_DIR = "spots_repo_bip_quad_zero_model_test"
SPOTS_DIR = "/mnt/opal_GUI/20181207_e2v_bf-30um/"
spots_sequence_numbers = list(np.arange(200,230,2))
FLATS_REPO_DIR = "flats_repo_bip_quad_zero_model_test"
FLATS_DIR = "/mnt/opal_GUI/20181205_e2v_flats/"
flats_sequence_numbers = list(np.arange(100,300,20))+list(np.arange(101,301,20))
